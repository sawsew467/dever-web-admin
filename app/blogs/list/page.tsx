  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="text-center mt-[10px] mb-[20px] text-[20px] font-bold text-black dark:text-gray-500">
          Can see all blogs
        </h1>
        <div className="text-center flex flex-col ">
          <Link href={"/blogs/detail/1"}>Go to blog detail 1</Link>
          <Link href={"/blogs/detail/2"}>Go to blog detail 2</Link>
        </div>
