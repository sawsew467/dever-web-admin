...
import { dropdownBlogs, openBlogPending } from "@/redux/slices/sideBarControl";
import { GoClockFill } from "react-icons/go";

type pageProps = {
  params: { blogPendingListId: string };
};

function PendingBlogs({ params }: pageProps) {
      ...
      className={`w-[100%] ${
        isOpenSlidebar
          ? isMouseVisit
            ...
            : "sm:w-[calc(100%-65px)]"
          : "sm:w-[calc(100%-250px)]"
      } absolute right-0 top-[72px] bottom-0 h-fit duration-[0.3s] dark:text-white`}
    >
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex gap-[26px]">
                    <UnlinkButton
                      ...
                      icon={""}
                      iconPosition={"left"}
                      backgroundColor={`bg-primaryGreen`}
                      method={() => {}}
